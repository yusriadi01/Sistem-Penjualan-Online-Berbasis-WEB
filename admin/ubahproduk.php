...
<form method="post" enctype="multipart/form-data">
	<div class="form-group">
		...
		<input type="text" name="nama" class="form-control" value="<?php echo $pecah['nm_produk']; ?>">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<img src="../foto_produk/<?php echo $pecah['foto produk'] ?>" width="200">
	</div>
	<div class="form-group">
...
if (isset($_POST['ubah']))
{
	...
	if (!empty($lokasifoto)) 
	{
		...
		$koneksi->query("UPDATE produk SET nm_produk='$_POST[nama]',
